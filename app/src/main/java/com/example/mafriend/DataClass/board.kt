...
//adv 게시글 생성
data class advPostBody(val author:Int?,val title:String?,val content:String?,val category:Int?,val state:Int?,val party:String?)


//전체
data class boardGetBody(val state:Int?,val pk:Int?,val author:Int?,val author_userid:String?,val title:String?,val content:String?,val category:Int?,val star_point:Int?,val post_comment:ArrayList<commentGetBody>,val created_at: Date)
//카테고리별
